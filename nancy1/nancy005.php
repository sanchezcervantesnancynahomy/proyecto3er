            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="nav navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="/proyecto3r/nancy1/nancy006.html">Práctica 6</a><br>
                        <a class="dropdown-item" href="/proyecto3r/nancy1/peliculas.html">Práctica 7</a><br>
                        <a class="dropdown-item" href="/proyecto3r/nancy1/personajes.html">Práctica 8</a><br>
                        <a class="dropdown-item" href="/proyecto3r/nancy1/hpyrym.html">Práctica 9</a><br>
                    </div>
                </li>
                </ul>
